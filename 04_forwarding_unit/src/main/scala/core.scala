...
class PipelinedRV32Icore (BinaryFile: String) extends Module {
  ...
  // Forwarding Unit
  fwdUnit.io.rs1           := idBarrier.io.outRS1
  fwdUnit.io.rs2           := idBarrier.io.outRS2
  fwdUnit.io.uop           := idBarrier.io.outUOP
  fwdUnit.io.exBarrier_rd  := exBarrier.io.outRD
  fwdUnit.io.memBarrier_rd := memBarrier.io.outRD

  // IDBarrier → EX (with forwarding mux selects)
  ...
  exStage.io.fwd_A_sel       := fwdUnit.io.fwd_A_sel
  exStage.io.fwd_B_sel       := fwdUnit.io.fwd_B_sel
  exStage.io.exBarrier_data  := exBarrier.io.outAluResult
  exStage.io.memBarrier_data := memBarrier.io.outAluResult
